...
for i in range(9601, 10001):
    ...
    try:
        ...
        json_extract, len_of_hednotes, len_of_judgement = json_data_func(file_contents[i-9601])
...
print("mean headnotes sentences", int(avg_headnotes/400))
print("mean judgement sentences", int(avg_judgements/400))
